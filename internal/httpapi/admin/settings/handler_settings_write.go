...
func (h *Handler) updateSettings(w http.ResponseWriter, r *http.Request) {
	...
	adminCfg, runtimeCfg, compatCfg, responsesCfg, embeddingsCfg, visionCfg, blockerCfg, truncationCfg, autoDeleteCfg, historySplitCfg, currentInputCfg, thinkingInjCfg, aliasMap, err := parseSettingsUpdateRequest(req)
	if err != nil {
